...
private:
	...
	// オーディオ
    static Audio* m_MainThemeBGM;
    static Audio* m_SubThemeBGM;
    static Audio* m_WalkSE;
    static Audio* m_JumpSE;
    static Audio* m_DodgeSE;
    static Audio* m_HealSE;
    static Audio* m_BreakSE;
    static Audio* m_PressSE;
    static Audio* m_ChargeSE;
    static Audio* m_ChargeHeavySE;
    static Audio* m_ChargeLightSE;
    static Audio* m_EnemyAttackSE;
    static Audio* m_EnemyMagicSE;
...
public:
	...
	static Audio* GetMainThemeAudio() { return m_MainThemeBGM; }
    static Audio* GetSubThemeAudio() { return m_SubThemeBGM; }
    static Audio* GetWalkSEAudio() { return m_WalkSE; }
    static Audio* GetJumpSEAudio() { return m_JumpSE; }
    static Audio* GetDodgeSEAudio() { return m_DodgeSE; }
    static Audio* GetHealSEAudio() { return m_HealSE; }
    static Audio* GetBreakSEAudio() { return m_BreakSE; }
    static Audio* GetPressSEAudio() { return m_PressSE; }
    static Audio* GetChargeSEAudio() { return m_ChargeSE; }
    static Audio* GetChargeHeavySEAudio() { return m_ChargeHeavySE; }
    static Audio* GetChargeLightSEAudio() { return m_ChargeLightSE; }
    static Audio* GetEnemyAttackSEAudio() { return m_EnemyAttackSE; }
    static Audio* GetEnemyMagicSEAudio() { return m_EnemyMagicSE; }
